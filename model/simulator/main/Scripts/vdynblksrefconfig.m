function [varargout]= vdynblksrefconfig(varargin)
    ...
    switch maskMode
        ...
        case 1
            ...
            switch manType
                case 'Double Lane Change'
                    autoblksenableparameters(block, [], [],{'DLCGroup'},{'ISGroup';'CRGroup';'CMGroup';'SSGroup';'SDGroup'});
                    if manOverride
                        set_param([vehSys '/Driver Commands'],'driverType','Predictive Driver');
                ...
                case 'Increasing Steer'
                    autoblksenableparameters(block, [], [],{'ISGroup'},{'DLCGroup';'CRGroup';'CMGroup';'SSGroup';'SDGroup'});
                    if manOverride
                        set_param([vehSys '/Driver Commands'],'driverType','Longitudinal Driver');
                ...
                case 'Swept Sine'
                    autoblksenableparameters(block, [], [],{'SSGroup'},{'ISGroup';'DLCGroup';'CRGroup';'CMGroup';'SDGroup'});
                    if manOverride
                        set_param([vehSys '/Driver Commands'],'driverType','Longitudinal Driver');
                ...
                case 'Sine with Dwell'
                    autoblksenableparameters(block, [], [],{'SDGroup'},{'ISGroup';'DLCGroup';'CRGroup';'CMGroup';'SSGroup'});
                    if manOverride
                        set_param([vehSys '/Driver Commands'],'driverType','Longitudinal Driver');
                        set_param(block,'simTime','25');
                    end
                ...
                case 'Constant Radius'
                    autoblksenableparameters(block, [], [],{'CRGroup'},{'CMGroup';'DLCGroup';'ISGroup';'SSGroup';'SDGroup'});
                    if manOverride
                     set_param([vehSys '/Driver Commands'],'driverType','Predictive Driver');
                     set_param(block,'simTime','60');
                    end
                ...
                case 'Custom Maneuver'
                    autoblksenableparameters(block, [], [],{'CMGroup'},{'DLCGroup';'ISGroup';'SSGroup';'SDGroup';'CRGroup';});
                    if manOverride
                        set_param([vehSys '/Driver Commands'],'driverType','Longitudinal Driver');
                        set_param(block,'simTime','60');
                    end
...
function update3DScene(block,manType)
    ...
    if strcmp(manType,'Custom Maneuver')
        set_param(sim3DBlkPath,'SceneDesc','Straight road');
    end
end