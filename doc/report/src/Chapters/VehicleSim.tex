...
we re-casted all the initial code to a \mwSL{} project and integrated it with these new components.
	...
	\end{center}
		...
		\begin{figure}
			\centering
			\subfloat[][]{\includegraphics[height=0.12\textheight]{Images/Simulator/vis-dash-drv}}\quad
			\subfloat[][]{\includegraphics[height=0.12\textheight]{Images/Simulator/vis-dash-veh}}
