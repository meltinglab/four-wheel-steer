...
\chapter{System Analysis: Stability, Reachability and Equilibrium Points}
	...
	\begin{figure}
		\centering
		\lstinputlisting[caption={[Eigenvalues]}, firstline=75, lastline=80, firstnumber=75]{../../../model/LinPlant.m}
	...
	\begin{figure}
		\centering
		\lstinputlisting[caption={[Reachability]}, firstline=86, lastline=90, firstnumber=86]{../../../model/LinPlant.m}
